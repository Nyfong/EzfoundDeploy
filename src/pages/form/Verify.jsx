      ...
      <div className="w-[40%] bg-slate-100 p-5 rounded-md">
        ...
        >
          <Form className="w-full bg-grey-100 px-6 rounded-md py-10 flex flex-col items-center">
            <div className="mb-5">
              <img className="mx-auto w-28 h-28" src="../src/assets/login/verify.png" alt="" />
            </div>
            <div>
              <h3 className="text-semiBlue-500 text-header-4 font-bold">Check your email</h3>
              <p className="text-semiBlue-500 text-header-6 font-semibold">We sent a verification code to your email.</p>
            </div>
            <label
              htmlFor="otp_code"
            ...
            />
            <ErrorMessage name="otp_code" className="text-primary-600" component="div" />

            {/* Verify button */}
            <button type="submit" className="text-primary-600 mx-auto w-1/2 mt-5 border border-grey-300 hover:bg-grey-600 focus:ring-2 focus:ring-blue-200 font-medium rounded-2xl text-lg px-5 py-2.5 hover:text-white dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
              Verify
            </button>
            {/* Back to login */}
            <button
